...
abstract class FlutterFlowTheme {
  ...
  late Color conforme;
  late Color naoConforme;
  late Color reinspecionado;
  late Color realizadas;
  late Color naoAplicaveis;
  late Color alerta;
  late Color fundoTabelas;
  late Color bordas;
  late Color fundoImput;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF25AD79);
  ...
  late Color conforme = const Color(0xFF25AD79);
  late Color naoConforme = const Color(0xFFFF3D00);
  late Color reinspecionado = const Color(0xFFFF9300);
  late Color realizadas = const Color(0xFF1F2935);
  late Color naoAplicaveis = const Color(0xFF707070);
  late Color alerta = const Color(0xFFFF4C6C);
  late Color fundoTabelas = const Color(0xFFFFFFFF);
  late Color bordas = const Color(0xFFD6D6D6);
  late Color fundoImput = const Color(0xFFFCFCFC);
}
